...
public class EventHandlerGroup<T> {
	 ...
	 * handler <code>A</code> must process events before handler <code>B</code>:
	 * </p>
	 * 
	 * <pre>
	 ...
	 * 
	 * @param handlers
	 *            the batch handlers that will process events.
	 ...
	 * 
	 * @param handlers
	 *            the work handlers that will process events. Each work handler
	 *            instance will provide an extra thread in the worker pool.
	 * @return a {@link EventHandlerGroup} that can be used to set up a event
	 *         processor barrier over the created event processors.
	 */
