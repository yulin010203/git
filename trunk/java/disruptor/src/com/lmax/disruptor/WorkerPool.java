...
public final class WorkerPool<T> {
	 ...
	 * 
	 * @param ringBuffer
	 *            of events to be consumed.
	 * @param sequenceBarrier
	 *            on which the workers will depend.
	 * @param exceptionHandler
	 *            to callback when an error occurs which is not handled by the
	 *            {@link WorkHandler}s.
	 * @param workHandlers
	 *            to distribute the work load across.
	 */
	public WorkerPool(final RingBuffer<T> ringBuffer, final SequenceBarrier sequenceBarrier, final ExceptionHandler exceptionHandler, final WorkHandler<T>... workHandlers) {
	 ...
	 * 
	 * @param eventFactory
	 *            for filling the {@link RingBuffer}
	 * @param exceptionHandler
	 *            to callback when an error occurs which is not handled by the
	 *            {@link WorkHandler}s.
	 * @param workHandlers
