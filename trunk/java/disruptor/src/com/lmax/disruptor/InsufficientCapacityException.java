...
/**
 * <p>
 * Exception thrown when the it is not possible to insert a value into the ring
 * buffer without it wrapping the consuming sequenes. Used specifically when
 * claiming with the {@link RingBuffer#tryNext()} call.
 * 
 * <p>
