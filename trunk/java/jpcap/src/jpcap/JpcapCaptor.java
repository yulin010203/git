...
public class JpcapCaptor extends JpcapInstance {
	...
	/**
	 * Opens the specified network interface, and returns an instance of this
	 * class.
	 * 
	 ...
	 * @param to_ms
	 *            Timeout of {@link #processPacket(int,PacketReceiver)
	 *            processPacket()}. Not all platforms support a timeout; on
	 *            platforms that don't, the timeout is ignored. On platforms
	 *            that support a timeout, a zero value will cause Jpcap to wait
	 ...
	 * 
	 * Unlike loopPacket(), this method returns (althrough not guaranteed) when
	 * the timeout expires. Also, in "non-blocking" mode, this method returns
	 * immediately when there is no packet to capture.
	 * 
	 * @param count
	 ...
	 * <P>
	 * 
	 * Unlike processPacket(), this method ignores the timeout. This method also
