...
public class JpcapSender extends JpcapInstance {
	 ...
	 * When sending a packet via a raw socket, the datalink header of the packet
	 * is ignored (= automatically generated by OS).
	 * <P>
	 * Note: the implementation and behavior of a raw socket may vary in
	 * different OS. Also, you can only open one raw socket at a time.
	 * 
	 * @throws IOException
	 *             Raised when initialization of the interface failed
	 * @return intstance of this class (JpcapSender)
	 ...
	 * the Datalink layer's header (e.g., Ethernet header) of the packet.
	 * <P>
	 * 
	 ...
	 * Note: the implementation and behavior of a raw socket may vary in
	 * different OS. For example, in Windows 2000/XP, you need to manually set
	 * the datalink/IP headers of a packet.
	 * 
	 * @param packet
	 *            Packet to be sent
	 */
