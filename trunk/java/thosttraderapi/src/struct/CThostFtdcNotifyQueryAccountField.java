 ...
 * @author 陈霖 2015-5-4
 */
public class CThostFtdcNotifyQueryAccountField extends Structure {
	/**
	 * 交易代码
	 */
	...
	protected List getFieldOrder() {
		return Arrays.asList(new String[] { "TradeCode", "BankID", "BankBranchID", "BrokerID", "BrokerBranchID", "TradeDate", "TradeTime", "BankSerial", "TradingDay", "PlateSerial", "LastFragment",
				...
				"VerifyCertNoFlag", "CurrencyID", "Digest", "BankAccType", "DeviceID", "BankSecuAccType", "BrokerIDByBank", "BankSecuAcc", "BankPwdFlag", "SecuPwdFlag", "OperNo", "RequestID", "TID",
				"BankUseAmount", "BankFetchAmount", "ErrorID", "ErrorMsg" });
	}

	/**
	 * 指针
	 */
	public static class ByReference extends CThostFtdcNotifyQueryAccountField implements Structure.ByReference {
	}

	/**
	 * 值
	 */
	public static class ByValue extends CThostFtdcNotifyQueryAccountField implements Structure.ByValue {
	}
}
