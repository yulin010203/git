...
public class CThostFtdcReqUserLoginField extends Structure {
	 ...
	 * 指针
	 */
	public class ByReference extends CThostFtdcReqUserLoginField implements Structure.ByReference {
	}

	/**
	 * 值
	 */
	public class ByValue extends CThostFtdcReqUserLoginField implements Structure.ByValue {
	}
}
