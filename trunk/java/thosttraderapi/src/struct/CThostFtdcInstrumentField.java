...
public class CThostFtdcInstrumentField extends Structure {
	 ...
	 * 指针
	 */
	public class ByReference extends CThostFtdcInstrumentField implements Structure.ByReference {
	}

	/**
	 * 值
	 */
	public class ByValue extends CThostFtdcInstrumentField implements Structure.ByValue {
	}
}
