 ...
 * @author 陈霖 2015-5-4
 */
public class CThostFtdcInvestorPositionField extends Structure {
	 ...
	 * 指针
	 */
	public static class ByReference extends CThostFtdcInvestorPositionField implements Structure.ByReference {
	}

	/**
	 * 值
	 */
	public static class ByValue extends CThostFtdcInvestorPositionField implements Structure.ByValue {
	}
}
